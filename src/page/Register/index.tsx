    ...
    <div id="main-wrapper" className="oxyy-register-register">
      <div className="container-fluid px-0">
        <div className="flex min-h-screen">
          ...
          <div className="flex-shrin  k-0 w-full md:w-1/2 lg:w-1/3 bg-gray-100 shadow-lg order-2 md:order-1 flex flex-col  ">
            <div className="p-8  my-auto py-5">
              <div className="mx-auto text-center">
                <div className="mb-6">
                  <a
                    className="text-3xl text-center text-orange-500 font-bold leading-none flex justify-center"
                    href="#"
                  >
                ...
                >
                  ...
                  <div className="form-check text-start my-4">
                    <input
                      ...
                      type="checkbox"
                    />
                    <label className="text-sm mt-8" htmlFor="agree">
                      {" "}
                      أنا اوافق على <a href="#"> </a>
          ...
          {/* Login Form End */}
          {/* Welcome Text */}
          <div className="flex-shrink-0 w-full md:w-1/2 lg:w-2/3 order-1 md:order-2">
            <div className="hero-wrap h-full">
              <div
                className="hero-bg hero-bg-scroll w-full h-full bg-cover bg-center"
