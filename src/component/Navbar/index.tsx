...
const navigation = [
  { name: "التصنيفات", href: "#", current: true },
  { name: "ما الجديد", href: "#", current: false },
  { name: "الأكثر تحميلا", href: "#", current: false },
  { name: "خطط الاسعار", href: "plans", current: false },
];
      ...
      <div>
        <nav className="relative px-6 py-4 flex justify-between items-center bg-[#FFEDE5] z-50  ">
          ...
          <ul className="hidden absolute top-1/2 left-1/2 transform -translate-y-1/2 -translate-x-1/2 lg:flex lg:mx-auto lg:flex lg:items-center lg:w-auto lg:space-x-6">
            {navigation.map((item, index) => (
              <Fragment key={index}>
                <li>
                  <Link
                    className="text-sm text-natural-100 hover:text-gray-500"
                    to={item.href}
                  >
          ...
          {isAuthenticated ? (
            ...
            <div>
              <a
                className="hidden lg:inline-block lg:mr-auto lg:ml-3 py-3 px-4 bg-gray-50 hover:bg-gray-100 text-sm text-gray-900 font-bold  rounded-lg transition duration-200"
                href="login"
              >
                {" "}
                تسجيل الدخول
              ...
              <a
                className="hidden lg:inline-block py-3 px-4 bg-orange-500 hover:bg-orange-600 text-sm text-white font-bold rounded-lg transition duration-200"
                href="register"
              >
                التسجيل
              </a>
